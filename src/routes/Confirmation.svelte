...
<img
	...
	height="200"
/>
<p class="mt-3 font-serif text-xl text-center">
	Get excited because we're going to <br />
	<a class="text-pink-700" href="https://maps.app.goo.gl/xGxkxDy5bV6dtZpDA">Seven Saints</a>
	in Downtown Champaign
</p>
<a onclick={() => setClickedYes(false)} class="mt-0.5 text-pink-700 text-sm cursor-pointer">
	[go back]
</a>
